...
---
## Hi there 👋
Chukwuemeka is an experienced professional with a diverse skill set in Cloud Computing, Software Development, Big Data, and GIS. He excels in understanding business and technical requirements, and has successfully implemented solutions for a wide range of clients spanning various industries. He enjoys collaborating with cross-functional teams, leveraging essential technologies and tools to drive impactful projects and solve customer issues in fast-paced environments. 

<h1 align="left"><img src="https://readme-typing-svg.herokuapp.com/?font=Righteous&size=35&center=true&vCenter=true&width=500&height=70&duration=4000&lines=Open+to+roles+such+as;+Cloud+Architect;+Cloud+Engineer;+DevOps+Engineer;+Cloud+Developer;+Data+Engineer;+Geospatial+Data+Analyst;+Geospatial+Data+Engineer;+React(Nextjs)+Developer;+Web+Developer;+Frontend+Engineer;+Software+Developer"/>
</h1>

<br/>

- 🔭 I’m currently developing and administering several web based projects for **Nkponani Limited ( Nobus Cloud company )** - Website, Webadmin, Management Dashboard, Admin Dashboard ( Nodejs, React(Nextjs), Javascript, Typescript, Python(Django), MySql, Sqlite, HTML, CSS, TailwindCSS, MongoDB, Mongoose, Docker, GitLab, RestAPI, JIRA, OpenAPI(SwaggerUI), Git, Windows Server, Linux, Bash/Shell, System Administration, NGINX, PM2, Apache, Certbot, Cloud Vms, Haproxy, Server Administration, Nagios, Zabbix, Security, Networking, Vercel, OpenStack, etc )
...
<div align="left"> 
 <a href="https://partner.cloudskillsboost.google/public_profiles/51f4be5e-4a78-4727-ac47-c2cf66032db0" target="_blank">
    <img style="width:100px; height:100px" src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwebcatalog.io%2Fen%2Fapps%2Fgoogle-cloudskillsboost%2F&psig=AOvVaw3916JE--jDFOli8GU9bHuX&ust=1719220359224000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCKD9voux8YYDFQAAAAAdAAAAABBq" />
  </a>
...
| <img height="50" src="https://user-images.githubusercontent.com/25181517/183345124-0948a5e0-5326-495f-824f-b99d3aee5467.png"> |      Vault      |
...
|                                                        Technology Icon                                                        | Technology Name | 
| :---------------------------------------------------------------------------------------------------------------------------: | :-------------: | 
| <img height="50" src="https://user-images.githubusercontent.com/25181517/183569191-f32cdf03-673f-4ae3-809b-3a8b376bb8a2.png"> |  Elasticsearch  | 
| <img height="50" src="https://user-images.githubusercontent.com/25181517/184357834-eba1eee1-6074-4b9c-8ed3-5373868096cc.png"> |  Spark   | 
| <img height="50" src=""> |  Beam | 
...
| <img height="50" src=""> |  Flink   | 
| <img height="50" src=""> |   DBT  | 
