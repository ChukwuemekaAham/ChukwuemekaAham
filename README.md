...
- 🔭 I’m currently engineering several web based projects for **Nkponani Limited ( the Nobus Cloud company )** ( React(Nextjs), Javascript, Typescript, Nodejs, Python(Django), MySql, Sqlite, HTML, CSS, TailwindCSS, MongoDB, Mongoose, Docker, Git, GitLab, Github Actions, RestAPI, JIRA, Asana, Trello, OpenAPI(SwaggerUI), Windows Server, Linux, Bash/Shell, System Administration, NGINX, PM2, Apache, Certbot, Cloud Vms, Haproxy, Server Administration, Nagios, Zabbix, Security, Networking, Vercel, OpenStack, etc )
